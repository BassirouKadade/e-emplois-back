...
const { ajouter,ajouterModuleFormateur,getInfosFormateur,supprimerModuleFormateur, allModules,modulesFormateur, supprimer, update, searchNext, liste } = require('../controllers/moduleContrioller/module');
